...
import com.example.sharan.ei_massignorder.data.OrderContract.OrderEntry;
...
public class OrderDbHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "order.db";
...
//                OrderEntry.COLUMN_LOCATION_SETTING + " TEXT UNIQUE NOT NULL, " +
                ...
                OrderEntry.COLUMN_F_ASSIGNED + " TEXT NOT NULL, " +
                OrderEntry.COLUMN_CONTACT + " REAL NOT NULL " +
                " );";
